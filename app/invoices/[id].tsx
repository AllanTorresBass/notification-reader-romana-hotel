...
import { InvoicePaymentDetailCard } from '@/components/invoices/InvoicePaymentDetailCard';
...
import { findLocalRegisterByInvoiceId } from '@/lib/invoices/find-local-register-for-invoice';
import {
  formatCurrency,
  formatInvoiceDate,
...
export default function InvoiceDetailScreen() {
  ...
  const localRegisterQuery = useQuery({
    queryKey: ['local-register-by-invoice', id],
    queryFn: () => findLocalRegisterByInvoiceId(id ?? ''),
    enabled: Boolean(id),
  });
  ...
  return (
    <>
      ...
      <AppScreen subtitle={clientName}>
        ...
        {invoice.payment ? (
          <InvoicePaymentDetailCard
            payment={invoice.payment}
            localRegister={localRegisterQuery.data}
          />
        ) : null}
